...
% (: is optional)
%
% This function reads an input MPO file and stores the image data into a MATLAB matrix.
% especially focusing on photos taken with FujiFilm W3) and store the image data into a MATLAB matrix.
%
% [input]
% mpofile      : input file name with a RELATIVE path format
...
% Last Update: "2015-07-02 10:06:03 ban"
